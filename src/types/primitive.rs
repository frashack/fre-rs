...
impl<'a> int<'a> {
    ...
    pub fn new (frt: &FlashRuntime<'a>, value: i32) -> Self {
...
impl<'a> uint<'a> {
    #[allow(unused_variables)]
    pub fn new (frt: &FlashRuntime<'a>, value: u32) -> Self {
        let mut obj = std::ptr::null_mut();
...
impl<'a> Number<'a> {
    #[allow(unused_variables)]
    pub fn new (frt: &FlashRuntime<'a>, value: f64) -> Self {
        let mut obj = std::ptr::null_mut();
...
impl<'a> Boolean<'a> {
    #[allow(unused_variables)]
    pub fn new (frt: &FlashRuntime<'a>, value: bool) -> Self {
